Public Class Frm_Inv_SalesAr
    Private Sub Frm_Inv_SalesAr_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        FillInv_Spplier()
        FillGen_Branchs()
        FillAcc_Paments()
        Label2.Text = Now
        ...
        Dim da As New SqlClient.SqlDataAdapter("SELECT    isnull(max(PUM_Id),0) + 1 as PUM_Id     FROM          TbL_Inv_SalesMaster", con)
    ...
    Private Sub RadButton5_Click(sender As Object, e As EventArgs) Handles RadButton5.Click
        If RadTextBox2.Text = String.Empty Then
            MsgBox("الرجاء ادخال رقم فاتوره المبيعات")
            RadTextBox2.Focus()
        ...
        Else
            ...
            For i = 0 To DataGridView1.Rows.Count - 2
                ...
                Dim da3 As New SqlClient.SqlDataAdapter("INSERT         INTO              TBL_Inv_Batches(B_Barcode, B_Name, B_INQTY, B_OQTY, B_Balance, B_Source, Item_id)  VALUES        (N'" & DataGridView1.Rows(i).Cells("Item_BarCode").Value & "', N'" & DataGridView1.Rows(i).Cells("Item_NameAr").Value & "',0, N'" & DataGridView1.Rows(i).Cells("SumQty").Value & "',  0, N'مبيعات', N'0')  ", con)
